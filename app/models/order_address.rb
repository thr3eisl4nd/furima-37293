class OrderAddress
  ...
  attr_accessor :zipcode, :shipment_source_id, :address1, :address2, :building_name, :phone_number, :order_id, :item_id,
                :user_id, :token
  ...
  def save
    ...
    Address.create(zipcode: zipcode, shipment_source_id: shipment_source_id, address1: address1, address2: address2,
