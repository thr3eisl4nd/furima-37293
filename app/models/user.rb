class User < ApplicationRecord
  ...
  validates phonetic_family_name, presence: true, format: { with: /A\[ァ-ヴー]+\z/u, meesage: "全角カタカナのみで入力して下さい" }
  validates phonetic_first_name, presence: true, format: { with: /A\[ァ-ヴー]+\z/u, meesage: "全角カタカナのみで入力して下さい" }
